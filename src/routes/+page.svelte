...
<div class="app-container">
  ...
  <div class="footer-section">
    ...
    <footer class="app-footer">
      <p>WoW M+ Loot Planner — Current season loot data. Not affiliated with Blizzard Entertainment.</p>
    </footer>
  </div>
</div>
...
<style>
  ...
  /* Primera definición de .main-content eliminada */
